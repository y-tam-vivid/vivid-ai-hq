...
### 【チョッパー / mini 2026-09-14 09:1x】★マージン全体の数え直しと調整（有璽氏「仕上がってないものがある」）── 着手
...
**★デプロイさせない**（窓口が出す）。比率の値（0.875/0.6/32px）は変えさせない。
指示文 `~/.vivid-relay/chopper_margin_all.txt` ／ 出口 `chopper_margin_all_result.md`。

**★同じ対象に手をつけないでください**: `~/lifestandup-wp/theme/lifestandup/` 配下のCSS全部
