...
- **`08_関係フォロー`** … **仕上げ（㉗v3）まで本実行済み。08は回る状態になった**（2026-08-15 07:50）
  ...
  - **データ投入を実施中（2026-08-18）** ── engagement/search の19社を投入する
    - ㊲ `1VqEcT957n5HIDtyrK_RVTBrqlBw9gX4vnFPrlrdmNMw`（ドライラン＋本実行）
    - バックアップ `1n2oDrSTA_Z9QpkGxS318lU2yKY8W5Xl5MJojTC__OSU`（20260818-1356・中身確認済み）
    - 00へ17社（780〜796行）／08へ19行（3〜21行）。既存777件には触らない
