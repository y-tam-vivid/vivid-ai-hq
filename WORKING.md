...
- **【リリス / MacBook 2026-09-04】LIFE STAND UP フォームをCF7へ接続 ── 着手**
  - 対象: `~/lifestandup-wp/theme/lifestandup/functions.php`（`lsu_cf7_form_id()`周辺）
    ＋`proposal/`配下（新規PDF）。①見学・お問い合わせをCF7 `7b81a8b`へ暫定接続
    ②採用応募フォーム新設の手順書PDFを作成
  - **★同じ対象に手をつけないでください**: 上記2点
