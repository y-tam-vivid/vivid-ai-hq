...
- [業務の単位まで割る](feedback_break_down_to_the_work_level.md) — **🔴9/8「一口にRPOと言っても何をやるのか分からない。具体性がない。中身がなくない？」＝集計で止めるな。★人を割り当てる先は困りごとでなく★業務。1行＝1業務で誰が/いくら/自社可否を揃える。価格帯は参考値でも必ず添える。掛け合わせ候補も出す。★形はスプレッドシート・Webは足すもの**
