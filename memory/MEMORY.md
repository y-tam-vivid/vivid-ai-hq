...
- [一人で抱えるな](feedback_use_the_team_not_alone.md) — **★9/13「私がやるべきことはない？」と聞かせた＝報告に手番が無かった。★最後に2行「有璽氏の手番◯件／こちらの手番」。0件こそ書く**／承認は記録と同じターンで投げる
...
- [AI社員オフィス＝会議室](project_ai_office_console.md) — **★9/13 ★Slackだと埋もれる＝会議室に「私の判断待ち」タブが要る（承認より広い）。★build_pending_humanは在るが読むだけ・稼働盤に埋没**／30秒更新は稼働中
