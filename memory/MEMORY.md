...
- [IGをサイトへ出す](project_lifestandup_website_wordpress.md) — **✅9/9 接続完了（Smash Balloon・FBページ不要）。残＝ショートカットを控えてサイトへ埋め込む。★当方の誤り＝出ない画面を予言して人を待たせた（分岐は表示されなかった）。人へ渡す手順は「出たら教えて・出なければ次へ」と書く**
