...
- [制作は原則miniへ](reference_offload_long_work_to_mini.md) — ★9/5恒久化。MacBookで担当を起こさない／**🔴9/5「miniが止まらないように」が要件化。止まる型3つ(ダイアログ待ち/30分打切り/判断待ちの塞ぎ)。★走行中のclaude -pを見る役が0件＝①は誰も検知していない。見るのは生死でなくログ更新時刻**
