...
- [同じ依頼が2つのセッションへ入る](reference_two_sessions_built_the_same_thing.md) — ⛔9/6巻き戻りの真因＝cron*/15の無条件上書き（受け取る側だけ直すと15分で消える）／**🔴9/7 3例目＝agent_watchdog.pyが申告なしでcron*/5稼働（kill -9の経路あり・心拍なし）。★心拍前提の検査は心拍を打たないものを構造的に見逃す**
