...
- [法人番号が埋まらない真因は台帳の社名欄](reference_ledger_name_blocks_corp_match.md) — **151件の空欄のうち機械で確定できたのは8件**。国税庁側に無いのではなく①法人名＋施設名を1セルに同居（医療法人幸人会 田島クリニック）②社名の誤記（ジブラルタ**ル**生命＝実在は「ジブラルタ生命」）③2社をスラッシュ連結、で突合が死ぬ。★社名完全一致でも都道府県が食い違えば別法人。実体=`~/.vivid-relay/corp_number_fill.py`（既定は読むだけ）
