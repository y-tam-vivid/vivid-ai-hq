...
- [同じ依頼が2つのセッションへ入る](reference_two_sessions_built_the_same_thing.md) — **⛔9/6 巻き戻りの真因を特定＝2体走ったからではない。vivid-sync.sh:194がcron*/15でbin/hooks/*.pyを~/.vivid-relay/へ無条件上書き。受け取る側だけ直すと15分で消える。同時に起きた事象を原因にするな**
