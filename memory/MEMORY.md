...
- [控えは置き場も中身も](reference_backups_in_volatile_places.md) — ★消える場所もgit下も不可。bin/hooksの控えは_backups/へ。名指しで保存する／**★9/8 4例目＝相手のツールの作業フォルダも不可(Claude Designが掃除して控えごと消えた)。ls -laのawk $NFは日本語名を切る**
