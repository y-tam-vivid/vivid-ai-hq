...
- [分けるのはセッションでなく担当](feedback_one_session_split_by_owner.md) — **🔴9/9「ウェブも一人でやらせるより何人か」＝★実測すると体不足でなく★ビビが全部リリスへ投げていた（ピタゴラスは15:50が1本目・ステラは0回）。★割り方はA=ページ(必ず競合・今日これ)／★B=工程(既存5体はこの形)／C=案件。★増やす前に割り当てを直す**／有璽氏へは1本にまとめて出す／**★9/7「担当は増やしてよい・単純作業に割れ・営業の管理役を置け」。「割ると動きがいい」は未実測＝測ってから断定。足す前に既存14体と重ならないか確かめる。★命名は役割の性格で（検査役=海軍／営業=攻める側）。★「攻める役」と「回す役」は別の1体にする**
