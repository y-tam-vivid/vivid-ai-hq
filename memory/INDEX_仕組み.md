...
- [corrections.logは86%が非有璽氏だった](reference_corrections_log_polluted_by_non_utterances.md) — ★9/19 探針汚染＋AI起動プロンプトの自己参照ループ+task-notification+run_agent.sh定型文の4経路。判定は「有璽氏が絶対に書かない形」に限定
