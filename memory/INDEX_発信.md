...
- [オレンジワークス ポートフォリオサイト](project_orangeworks_portfolio_site.md) — **STUDIO無料・本体WordPressとは別物**。WORKS42件一覧まで完成／残=カルーセル削除・料金と連絡先の確定・並び順／**★STUDIOはCSVインポート不可＝手入力・構築はGUI操作でAI代行不可**／素材と原稿は`~/orangeworks-portfolio/`
