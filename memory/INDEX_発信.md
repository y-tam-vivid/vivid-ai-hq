...
- [オレンジワークス ポートフォリオサイト](project_orangeworks_portfolio_site.md) — **★WordPress(orange-works.co)で確定。9/14ログイン完了・投入スクリプト実装済(全件draft・rollback可)。★当方専用の鍵claude-worksの保存待ち**／★Desktop側がSEOで同じWPを並走(鍵claude-kiji・触らない)
