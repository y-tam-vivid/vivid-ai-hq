...
- [LSU フォームIDは9/4版が誤り](project_lifestandup_website_wordpress.md) — ★9/7 正しいCF7フォームIDは`e8e3131`（9/4の暫定接続`7b81a8b`は誤り・有璽氏が本番管理画面で確認）。法定開示は案A確定(01自己評価/03支援プログラムのみ残す・02/04は消す)。保護者の声は取材回答シートから実データを入れる(そのまま貼らず整えて掲載)
