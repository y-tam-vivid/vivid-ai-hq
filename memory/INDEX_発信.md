...
- [LSU WordPress移行(②)に今日中に着手](project_lifestandup_website_wordpress.md) — ★9/9 ①デモ完成(別担当・theme/配下)と②WordPress移行(ピタゴラス)を並走。②は`migration/`配下限定でtheme/のCSS・PHPに触れない(9/9はCSS7本のmerge競合が実際に発生した当日)
